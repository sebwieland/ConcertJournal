...
const CreateNewEntryFormPage = () => {
    ...
    return (_jsx(EntryForm, { onSubmit: async (formData) => {
            const formattedData = {
        ...
        }, bandName: bandName, setBandName: setBandName, place: place, setPlace: setPlace, date: date, setDate: (newDate) => setDate(newDate.format("YYYY-MM-DD")), rating: rating, setRating: setRating, comment: comment, setComment: setComment, message: message, isSuccess: isSuccess, data: data || [], showArtistDetailsButton: true }));
};
export default CreateNewEntryFormPage;
//# sourceMappingURL=NewDataEntryPage.js.map