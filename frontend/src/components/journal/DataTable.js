        ...
        { field: "comment", headerName: "Comment", width: 130 },
        {
            ...
            renderCell: (params) => {
                ...
                if (params.value === undefined || params.value === null) {
                    ...
                    return _jsx(RatingStars, { rating: 0 });
                }
                return _jsx(RatingStars, { rating: params.value });
            },
        },
        // Removed appUser column as requested by the user
        {
            ...
            renderCell: (params) => {
                ...
                if (params.id === undefined || params.id === null) {
                    ...
                    return (_jsxs("div", { children: [_jsx(Button, { variant: "contained", color: "primary", disabled: true, children: "Edit" }), _jsx(Button, { variant: "contained", color: "error", style: { marginLeft: 10 }, disabled: true, children: "Delete" })] }));
                }
                const id = typeof params.id === "number"
                    ? params.id
                    : parseInt(params.id, 10);
                return (_jsxs("div", { children: [_jsx(Button, { variant: "contained", color: "primary", onClick: () => this.props.onEdit(id), children: "Edit" }), _jsx(Button, { variant: "contained", color: "error", style: { marginLeft: 10 }, onClick: () => this.props.onDelete(id), children: "Delete" })] }));
            },
        },
    ];
    render() {
        const { data } = this.props;
        return (_jsx("div", { style: { height: 600, width: "100%" }, children: _jsx(DataGrid, { autoHeight: true, rows: data, columns: this.columns, pageSizeOptions: [5, 10, 25], initialState: {
