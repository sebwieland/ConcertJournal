...
describe("useAuthApi", () => {
    ...
    it("throws an error if AuthContext is not provided", () => {
        ...
        const noAuthWrapper = ({ children }) => (_jsx("div", { children: children }));
    ...
    describe("login", () => {
        it("calls apiClient.post with correct parameters", async () => {
            ...
            expect(mockPost).toHaveBeenCalledWith("/login", "email=test%40example.com&password=password123", {
...
//# sourceMappingURL=apiAuth.test.js.map