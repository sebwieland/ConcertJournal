...
describe("EntryForm Component", () => {
  ...
  it("renders the form with all fields", async () => {
    ...
    expect(
      screen.getByRole("button", { name: /create new entry/i }),
    ).toBeInTheDocument();
  });
  ...
  it("updates band name when input changes", async () => {
    ...
    render(<EntryForm {...mockEntryFormProps} setBandName={setBandName} />);
  ...
  it("updates place when input changes", async () => {
    ...
    render(<EntryForm {...mockEntryFormProps} setPlace={setPlace} />);
  ...
  it("updates comment when input changes", async () => {
    ...
    render(<EntryForm {...mockEntryFormProps} setComment={setComment} />);
  ...
  it("updates rating when rating changes", async () => {
    ...
    render(<EntryForm {...mockEntryFormProps} setRating={setRating} />);
  ...
  it("shows artist details button when showArtistDetailsButton is true", async () => {
    ...
    expect(
      screen.getByRole("button", { name: /artist details/i }),
    ).toBeInTheDocument();
  });
  ...
  it("does not show artist details button when showArtistDetailsButton is false", async () => {
    ...
    expect(
      screen.queryByRole("button", { name: /artist details/i }),
