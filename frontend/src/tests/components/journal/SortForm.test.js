...
describe("SortForm", () => {
    ...
    const defaultSortOrder = { column: "date", order: "desc" };
    beforeEach(() => {
        vi.clearAllMocks();
    });
    it("renders with the correct initial values", () => {
        renderWithProviders(_jsx(SortForm, { sortOrder: defaultSortOrder, onSortOrderChange: mockOnSortOrderChange }));
...
//# sourceMappingURL=SortForm.test.js.map