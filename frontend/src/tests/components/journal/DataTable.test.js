...
describe("DataTable", () => {
    ...
    it("renders the DataGrid with correct columns", () => {
        render(_jsx(DataTable, { data: mockEventData, onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it("handles empty data array", () => {
        render(_jsx(DataTable, { data: [], onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it("handles missing rating values", () => {
        ...
        render(_jsx(DataTable, { data: dataWithMissingRating, onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it("handles rows with default id values", () => {
        ...
        render(_jsx(DataTable, { data: dataWithDefaultId, onEdit: mockOnEdit, onDelete: mockOnDelete }));
    ...
    it("handles string id values in action buttons", () => {
        ...
        render(_jsx(DataTable, { data: dataWithStringId, onEdit: mockOnEdit, onDelete: mockOnDelete }));
        // Find all Edit buttons
        const editButtons = screen.getAllByText("Edit");
