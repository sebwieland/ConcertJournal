...
describe("RatingStars Component", () => {
    it("renders the component with correct rating", () => {
        renderWithProviders(_jsx(RatingStars, { rating: 3 }));
    ...
    it("renders with rating 5", () => {
        renderWithProviders(_jsx(RatingStars, { rating: 5 }));
    ...
    it("renders with rating 0", () => {
        renderWithProviders(_jsx(RatingStars, { rating: 0 }));
    ...
    it("handles decimal ratings correctly", () => {
        renderWithProviders(_jsx(RatingStars, { rating: 3.7 }));
...
//# sourceMappingURL=RatingStars.test.js.map