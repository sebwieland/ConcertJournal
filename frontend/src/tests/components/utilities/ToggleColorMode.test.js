...
describe("ToggleColorMode Component", () => {
    it("renders sun icon in dark mode", () => {
        ...
        render(_jsx(ToggleColorMode, { mode: "dark", toggleColorMode: mockToggleColorMode }));
    ...
    it("renders moon icon in light mode", () => {
        const mockToggleColorMode = vi.fn();
        render(_jsx(ToggleColorMode, { mode: "light", toggleColorMode: mockToggleColorMode }));
    ...
    it("passes additional props to the IconButton", () => {
        ...
        render(_jsx(ToggleColorMode, { mode: "light", toggleColorMode: mockToggleColorMode, "data-testid": testId }));
        const button = screen.getByTestId(testId);
        expect(button).toBeInTheDocument();
    });
});
//# sourceMappingURL=ToggleColorMode.test.js.map